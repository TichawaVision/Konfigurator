...
public class MaskController extends de.tichawa.cis.config.MaskController<VTCIS>
{
  ...
  public void initialize(URL url, ResourceBundle rb)
  {
    ...
    Color.valueProperty().addListener((ObservableValue<? extends String> observable, String oldValue, String newValue) ->
    {
      ...
      double maxLR = Math.round(1000 * sensorBoard.getLines() / (CIS_DATA.getSpec("Color") * (sensorChip.getPixelPerSensor() + 100) * 1.0 / Math.min(sensorChip.getClockSpeed(), adcBoard.getClockSpeed()))) / 1000.0;
