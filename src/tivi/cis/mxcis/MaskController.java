...
public class MaskController extends tivi.cis.MaskController
{
  ...
  public void initialize(URL url, ResourceBundle rb)
  {
    ...
    Color.valueProperty().addListener((ObservableValue<? extends String> observable, String oldValue, String newValue)
            -> 
            {
              if(newValue.equals("RGB") && CIS_DATA.getSpec("Internal Light Source") == 0 && CIS_DATA.getSpec("External Light Source") == 0)
              {
                Color.getSelectionModel().select(oldValue);
                return;
              }
              
              if(newValue.equals("RGB") && CIS_DATA.getSpec("Internal Light Source") != 0 && CIS_DATA.getSpec("Internal Light Source") != 2)
              {
                Color.getSelectionModel().select(oldValue);
                return;
              }
    ...
    ScanWidth.valueProperty().addListener((ObservableValue<? extends String> observable, String oldValue, String newValue)
            -> 
            {
              ...
              CIS_DATA.setSpec("sw_index", (sw / 260) - 2);
    ...
    InternalLightSource.valueProperty().addListener((ObservableValue<? extends String> observable, String oldValue, String newValue)
            -> 
            {
              ...
              if(CIS_DATA.getSpec("Color") == 4 && newValue.equals("None") && CIS_DATA.getSpec("External Light Source") == 0)
              {
                InternalLightSource.getSelectionModel().select(oldValue);
                return;
              }
              
              if(CIS_DATA.getSpec("Color") == 4 && !newValue.equals("None") && !newValue.equals("Two sided"))
              {
                InternalLightSource.getSelectionModel().select(oldValue);
                return;
              }
    ...
    ExternalLightSource.valueProperty().addListener((ObservableValue<? extends String> observable, String oldValue, String newValue)
            -> 
            {
              if((CIS_DATA.getSpec("Color") == 4 && CIS_DATA.getSpec("Internal Light Source") == 0 && newValue.equals("None")))
              {
